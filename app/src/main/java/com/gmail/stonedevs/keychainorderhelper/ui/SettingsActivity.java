    ...
    public boolean onPreferenceChange(Preference preference, Object value) {
      ...
      if (preference instanceof ListPreference) {
        ...
        if (!stringValue.isEmpty()) {
          ...
          String summary = "";
          if (Objects.equals(key, preference.getContext().getString(R.string.pref_key_rep_name))) {
            summary = preference.getContext().getString(R.string.pref_description_rep_name);
          } else if (Objects
              .equals(key, preference.getContext().getString(R.string.pref_key_rep_territory))) {
            summary = preference.getContext().getString(R.string.pref_description_rep_territory);
          }
